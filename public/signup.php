...
<head>
    ...
    <title>Create Account | National Healthcare System</title>
    ...
    <main class="signup-page">
        <section class="signup-visual">
            ...
            <div class="visual-content reveal-left">
                <span class="eyebrow">Integrated Healthcare Access</span>
                <h1>One account for care, records, appointments, and emergency support.</h1>
                <p>
                    Join as a patient to manage your healthcare profile or register a hospital to connect with the national healthcare network.
                </p>
            </div>

            <div class="image-panel reveal-up">
                <img src="https://images.unsplash.com/photo-1586773860418-d37222d8fce3?auto=format&fit=crop&w=1200&q=80" alt="Healthcare professional">
                <div class="metric-card">
                    <strong>24/7</strong>
                    <span>Emergency response access</span>
                </div>
            </div>
        </section>
        ...
        <section class="signup-form-section">
            <div class="form-shell reveal-right">
                <div class="form-heading">
                    ...
                    <h2>Get started</h2>
                    <p>Select the account type that matches how you want to use the platform.</p>
                </div>
                ...
                <form action="" method="post" class="signup-form">
                    <div class="account-switch" aria-label="Account type">
                        <input type="radio" name="role" id="patientType" value="patient" <?php
                        if ($role == "patient") {
                            echo "checked";
                        }
                        ?>>
                        <label for="patientType">Patient</label>

                        <input type="radio" name="role" id="hospitalType" value="hospital" <?php
                        if ($role == "hospital") {
                            echo "checked";
                        }
                        ?>>
                        <label for="hospitalType">Hospital</label>
                    </div>
                    <p class="field-error"><?php echo $errors["role"]; ?></p>

                    <div class="row g-3">
                        <div class="col-12">
                            <label for="fullName" class="form-label">Full name / Hospital name</label>
                            <input type="text" class="form-control" id="fullName" name="name" placeholder="Enter name" value="<?php echo htmlspecialchars($name); ?>" required>
                        ...
                        <div class="col-12">
                            <button type="submit" name="signup_submit" class="btn submit-button w-100">Create account</button>
                        </div>
                    </div>
                </form>
