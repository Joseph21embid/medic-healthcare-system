...
<body>
    <main class="signup-page">
        <section class="signup-visual patient-visual">
            <nav class="brand-bar">
                ...
                <form action="" method="post" class="signup-form">
                    ...
                    <div class="row g-3">
                        <div class="col-12">
                            ...
                            <input type="text" class="form-control" id="fullName" name="name" placeholder="Enter your full name" value="<?php echo htmlspecialchars($name); ?>" required>
